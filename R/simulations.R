SimulateGraph=function(n=100, pk=10, seed=1,
                       implementation="huge", topology="random", nu=0.1,
                       output_matrices=FALSE,
                       v_within=1, v_between=0.5,
...
SimulateXY=function(n=100, pk=10, seed=1, X=NULL, nu_pred=0.2, beta_min=1, beta_max=1, sd_pred_error=1, family="gaussian"){
  ...
  set.seed(seed)
  beta=stats::runif(p, min=beta_min, max=beta_max)
